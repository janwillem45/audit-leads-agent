...
class ZzpMarktScraper(Scraper):
    """ZZP-Markt.nl assignment search."""

    name = "zzp-markt"
    BASE = "https://www.zzp-markt.nl"
    SEARCH_URLS = [
        "https://www.zzp-markt.nl/opdrachten?q=audit",
        "https://www.zzp-markt.nl/opdrachten?q=auditor",
    ]
    ...
    def scrape(self) -> Iterable[Opportunity]:
        ...
        for url in self.SEARCH_URLS:
            ...
            items = (
                soup.select(".assignment, .opdracht, article")
